...
# Load dataset
# ===============================
df = pd.read_csv(r"C:\Users\trang\OneDrive\Desktop\Infosys SP Original\Backend\Data\train.csv")
...
print("\nRandom Forest model trained and saved as fraud_model_rf.pkl with SMOTE, class weights, F1 optimization, and ROC visualization.")